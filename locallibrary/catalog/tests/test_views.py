...
class AuthorListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        for author_num in range(number_of_authors):
            Author.objects.create(first_nadme='Christian %s' % author_num, last_name = 'Surname %s' % author_num,)
...
#Testes para Views restritas a usuarios registrados
...
#verifica se nossa visão apenas retorna livros que estão em empréstimo ao nosso mutuário atual
...
#Testes para Views com Formularios
class RenewBookInstancesViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_user2 = User.objects.create_user(username='testuser2', password='12345')
        test_user2.save()
        #Codigo para dar permissao aos usuarios criados no teste
        permission = Permission.objects.get(name='Set book as returned')
        test_user2.user_permissions.add(permission)
        test_user2.save() #fim do codigo de dar permissao
    ...
    #Verificam se apenas usuários com as permissões corretas ( testuser2 ) podem acessar a visualização.
    def test_redirect_if_not_logged_in(self):
    ...
    #verifica se a data inicial do formulário é de três semanas no futuro.
    ...
    #e a vista redireciona para uma lista de todos os livros emprestados se a renovação for bem-sucedida.
    ...
    #Estes novos POSTpedidos de teste , mas neste caso com datas de renovação inválidas.
